...
export const DETAIL_DATA = {
  ...
  food: {
    title: "B級グルメの宝庫",
    description: "瀬戸内の海の幸をふんだんに使った伝統的な「ばら寿司」や、濃厚なソースが絶品の「デミカツ丼」など、岡山には個性豊かなご当地グルメが揃っています。B級グルメから伝統の味まで、訪れる人々を虜にする深く豊かな食文化を存分に味わってください。",
    image: barazushiImg
  },
  momotaro: {
    title: "桃太郎伝説の舞台、吉備の国",
  ...
  tourism: {
    title: "風情あふれる歴史の町並み",
    description: "倉敷美観地区は、江戸時代の風情を残す白壁の屋敷や柳並木が美しい、岡山を代表する観光地です。倉敷川でのゆったりとした舟流しや、日本初の西洋美術館である大原美術館など、歴史とアートが融合したノスタルジックで特別な風景を楽しむことができます。",
    image: kurashikiImg
  },
  hiruzen: {
    title: "雄大な自然、蒜山高原",
